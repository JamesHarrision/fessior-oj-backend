...
import { Wrench, Send, Shield, Activity } from 'lucide-react';
  ...
  return (
    <div className="settings-view glass-card">
      <div className="settings-header">
        ...
        <p>Quản lý cấu hình tài khoản, phiên đăng nhập, lịch sử đấu và báo cáo lỗi</p>
        ...
        <div className="settings-tabs">
          ...
          >
            <Activity size={14} /> Chung & Lịch sử
          </button>
          <button
            className={`settings-tab-btn ${activeTab === 'account' ? 'active' : ''}`}
            onClick={() => setActiveTab('account')}
          >
            <Shield size={14} /> Xác thực & Bảo mật
          </button>
        </div>
      </div>
