...
const problem_validator_1 = require("../validators/problem.validator");
...
*/
problem_controller_1.problemController.getTags);
router.post('/tags', 
/* #swagger.tags = ['Problems']
...
*/
auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, problem_controller_1.problemController.createTag);
// Problems
// Problems
router.get('/', 
/* #swagger.tags = ['Problems']
...
*/
auth_middleware_1.optionalAuth, problem_controller_1.problemController.listProblems);
router.get('/:slug', 
/* #swagger.tags = ['Problems']
...
*/
problem_controller_1.problemController.getProblem);
router.post('/', 
/* #swagger.tags = ['Problems']
...
*/
auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, (0, validate_middleware_1.validateRequest)(problem_validator_1.createProblemSchema), problem_controller_1.problemController.createProblem);
router.put('/:id', 
/* #swagger.tags = ['Problems']
...
*/
auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, (0, validate_middleware_1.validateRequest)(problem_validator_1.updateProblemSchema), problem_controller_1.problemController.updateProblem);
router.delete('/:id', 
/* #swagger.tags = ['Problems']
...
*/
auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, problem_controller_1.problemController.deleteProblem);
// Testcases
// Testcases
router.post('/:problemId/testcases', 
/* #swagger.tags = ['Problems']
...
*/
auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, (0, validate_middleware_1.validateRequest)(problem_validator_1.createTestcaseSchema), problem_controller_1.problemController.addTestcase);
...
*/
auth_middleware_1.requireAuth, problem_controller_1.problemController.getTestcases);
...
*/
auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, problem_controller_1.problemController.deleteTestcase);
