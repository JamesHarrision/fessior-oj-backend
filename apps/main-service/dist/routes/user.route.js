...
router.get('/', auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, (req, res, next) => {
    /* #swagger.tags = ['Admin']
 ...
 */
router.patch('/me', (0, validate_middleware_1.validateRequest)(user_validator_1.updateMeSchema), (req, res, next) => {
    /* #swagger.tags = ['User']
...
router.post('/me/avatar', upload_middleware_1.upload.single('avatar'), (req, res, next) => {
    /* #swagger.tags = ['User']
...
router.get('/:id', auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, (req, res, next) => {
    /* #swagger.tags = ['Admin']
...
router.patch('/:id', auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, (0, validate_middleware_1.validateRequest)(user_validator_1.adminUpdateUserSchema), (req, res, next) => {
    /* #swagger.tags = ['Admin']
...
router.patch('/:id/role', auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, (0, validate_middleware_1.validateRequest)(user_validator_1.updateRoleSchema), (req, res, next) => {
    /* #swagger.tags = ['Admin']
...
router.post('/:id/ban', auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, (0, validate_middleware_1.validateRequest)(user_validator_1.banUserSchema), (req, res, next) => {
    /* #swagger.tags = ['Admin']
...
router.post('/:id/unban', auth_middleware_1.requireAuth, auth_middleware_1.requireAdmin, (req, res, next) => {
    /* #swagger.tags = ['Admin']
