...
router.post('/roadmap', (req, res, next) => {
    ...
    */
    ai_controller_1.aiController.generateRoadmap(req, res, next);
});
router.post('/feedback/:submissionId', (req, res, next) => {
    ...
    */
    ai_controller_1.aiController.generateMockInterviewFeedback(req, res, next);
});
router.post('/debug/:submissionId', (req, res, next) => {
    ...
    */
    ai_controller_1.aiController.explainFailure(req, res, next);
});
router.post('/interview/chat/:historyId', (req, res, next) => {
    ...
    */
    ai_controller_1.aiController.chatMockInterview(req, res, next);
});
router.get('/history', (req, res, next) => {
    /* #swagger.tags = ['AI Features']
       ...
       #swagger.security = [{ "bearerAuth": [] }]
    */
    ai_controller_1.aiController.getHistory(req, res, next);
});
