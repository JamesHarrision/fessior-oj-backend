...
| `/api/v1/ai` | `ai.route.ts` | AI Debug Assistant va Mock Interview Chat. |
| `/api/v1/roadmaps` | `roadmap.route.ts` | Generate AI DSA roadmaps, tracking progress, and sharing. |
